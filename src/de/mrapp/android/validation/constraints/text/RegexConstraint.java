...
/**
 * A constraint, which allows to verify a text in order to check, if it matches
...
public class RegexConstraint implements Constraint<CharSequence> {
	...
	/**
	 * Creates a new constraint, which allows to verify a text in order to
	 * check, if it matches a certain regular expression.
	 * 
	 * @param regex
	 ...
	 */
	public RegexConstraint(final Pattern regex) {
		setRegex(regex);
	}
	 ...
	 * 
	 * @return The regular expression, which is used to verify the texts, as an
	 *         instance of the class {@link Pattern}
	 */
	 ...
	 * 
	 * @param regex
	 *            The regular expression, which should be set, as an instance of
	 *            the class {@link Pattern}. The regular expression may not be
	 *            null
	 */
	public final void setRegex(final Pattern regex) {

 ...
 * one constraint is satisfied, the resulting constraint will also be satisfied.
 *
 * @param <Type>
...
public class DisjunctiveConstraint<Type> implements Constraint<Type> {
    ...
    /**
     * Creates a new constraint, which allows to combine multiple constraints in a disjunctive
     * manner.
     *
     * @param constraints
     ...
     */
    public DisjunctiveConstraint(@NonNull final Constraint<Type>[] constraints) {

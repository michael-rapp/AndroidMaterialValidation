 ...
 * manner. If at least one constraint is satisfied, the resulting constraint
 ...
 * @since 1.0.0
 */
public class DisjunctiveConstraint<Type> implements Constraint<Type> {
	 ...
	 */
	public DisjunctiveConstraint(final Constraint<Type>[] constraints) {
		setConstraints(constraints);
	}

	/**
	 * Creates and returns a constraint, which allows to combine multiple
	 * constraints in a disjunctive manner.
	 * 
	 * @param <Type>
	 *            The type of the values, which should be verified
	 * @param constraints
	 ...
	 *         class {@link DisjunctiveConstraint}
	 */

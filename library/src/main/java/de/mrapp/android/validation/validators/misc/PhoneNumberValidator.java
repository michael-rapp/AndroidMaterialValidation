...
public class PhoneNumberValidator extends RegexValidator {
	 ...
	 */
	public PhoneNumberValidator(final CharSequence errorMessage) {
	 ...
	 *            resource
	 */
	public PhoneNumberValidator(final Context context, final int resourceId) {

...
public class NoWhitespaceValidator extends AbstractValidator<CharSequence> {
	 ...
	 */
	public NoWhitespaceValidator(final CharSequence errorMessage) {
		super(errorMessage);
	}
	 ...
	 *            resource
	 */
	public NoWhitespaceValidator(final Context context, final int resourceId) {

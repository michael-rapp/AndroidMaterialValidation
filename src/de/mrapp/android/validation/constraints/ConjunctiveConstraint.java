...
/**
 * A validator, which allows to combine multiple constraints in a conjunctive
 * manner. Only if all single constraints are satisfied, the resulting
 * constraint will also be satisfied.
 * 
 * @param <Type>
...
public class ConjunctiveConstraint<Type> implements Constraint<Type> {
	...
	/**
	 * A array, which contains the single constraints, the constraint consists
	 * of.
	 */
	private Constraint<Type>[] constraints;

	/**
	 * Creates a new constraint, which allows to combine multiple constraints in
	 ...
	 */
	public ConjunctiveConstraint(final Constraint<Type>[] constraints) {
		setConstraints(constraints);
	}

	/**
	 * Creates and returns a constraint, which allows to combine multiple
	 * constraints in a conjunctive manner.
	 * 
	 * @param <Type>
	 *            The type of the values, which should be verified
	 * @param constraints
	 ...
	 *         class {@link ConjunctiveConstraint}
	 */
	 ...
	 * 
	 * @return The single constraints, the constraint consists of, as an array
	 *         of the type {@link Constraint}
	 */
	 ...
	 * 
	 * @param constraints
	 *            The single constraints, which should be set, as an array of
	 *            the type {@link Constraint}. The constraints may neither be
	 *            null, nor empty
	 */
	public final void setConstraints(final Constraint<Type>[] constraints) {

...
public class DomainNameValidator extends RegexValidator {
	 ...
	 * they represent valid domain names.
	 * 
	 * @param errorMessage
	 ...
	 */
	public DomainNameValidator(final CharSequence errorMessage) {
	 ...
	 *            resource
	 */
	public DomainNameValidator(final Context context, final int resourceId) {

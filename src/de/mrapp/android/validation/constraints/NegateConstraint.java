...
public class NegateConstraint<Type> implements Constraint<Type> {
	...
	/**
	 * Creates a new constraint, which allows to negate the result of an other
	 * constraint.
	 * 
	 * @param constraint
	 ...
	 */
	public NegateConstraint(final Constraint<Type> constraint) {
	 ...
	 * 
	 * @return The constraint, whose result is negated, as an instance of the
	 ...
	 * 
	 * @param constraint
	 *            The constraint, which should be set, as an instance of the
	 *            type {@link Constraint}. The constraint may not be null
	 */
	public final void setConstraint(final Constraint<Type> constraint) {

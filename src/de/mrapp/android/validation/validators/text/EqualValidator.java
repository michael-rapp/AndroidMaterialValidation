...
/**
 * A validator, which allows to validate texts to ensure, that they are equal to
 * the text, which is contained by an {@link EditText} widget.
 * 
 * @author Michael Rapp
 */
public class EqualValidator extends AbstractValidator<CharSequence> {
	...
	/**
	 * The edit text widget, which contains the content, the texts should be
	 * equal to.
	 */
	 ...
	 * they are equal to the text, which is contained by an {@link EditText}
	 * widget.
	 * 
	 * @param errorMessage
	...
	/**
	 * Returns the edit text widget, which contains the content, the texts
	 * should be equal to.
	 * 
	 * @return The edit text widget, which contains the content, the texts
	 *         should be equal to, as an instance of the class {@link EditText}
	 */
	...
	/**
	 * Sets the edit text widget, which contains the content, the texts should
	 * be equal to.
	 * 
	 * @param editText
	 *            The edit text widget, which should be set, as an instance of
	 *            the class {@link EditText}. The widget may not be null
	 */
	public final void setEditText(final EditText editText) {

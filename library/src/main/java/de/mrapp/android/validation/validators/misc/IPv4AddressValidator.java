...
public class IPv4AddressValidator extends RegexValidator {
	 ...
	 * they represent valid IPv4 addresses.
	 * 
	 * @param errorMessage
	 ...
	 */
	public IPv4AddressValidator(final CharSequence errorMessage) {
	 ...
	 *            resource
	 */
	public IPv4AddressValidator(final Context context, final int resourceId) {

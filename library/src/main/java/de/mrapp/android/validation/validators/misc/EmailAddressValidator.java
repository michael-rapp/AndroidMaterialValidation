...
public class EmailAddressValidator extends RegexValidator {
	 ...
	 * they represent valid email addresses.
	 * 
	 * @param errorMessage
	 ...
	 */
	public EmailAddressValidator(final CharSequence errorMessage) {
	 ...
	 *            resource
	 */
	public EmailAddressValidator(final Context context, final int resourceId) {

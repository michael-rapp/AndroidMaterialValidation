...
/**
 * A validator, which allows to validate texts to ensure, that they match
...
public class RegexValidator extends AbstractValidator<CharSequence> {
	 ...
	 */
	public RegexValidator(final CharSequence errorMessage, final Pattern regex) {
		super(errorMessage);
		setRegex(regex);
	}
	 ...
	 *            regular expression may not be null
	 */
	public RegexValidator(final Context context, final int resourceId,
			final Pattern regex) {
	 ...
	 * 
	 * @return The regular expression, which is used to validate the texts, as
	 *         an instance of the class {@link Pattern}
	 */
